...
const COLORS = ["#10B981", "#34D399", "#6EE7B7", "#52525B", "#A1A1AA"];
                ...
                return (
                    <div key={index} className="flex items-center justify-between gap-3 text-xs">
                        ...
                        <div className="flex items-center gap-2 ml-auto">
                            <span className="text-[#FAFAFA] font-medium tabular-nums">{entry.value}</span>
    ...
    return (
        <div className="flex flex-col h-full">
            <div className="flex items-center justify-between mb-4">
                <h3 className="text-sm font-semibold text-[#FAFAFA]">Browsers</h3>
            ...
            <CustomLegend
                payload={chartData.map((d, i) => ({ name: d.name, value: d.value, color: COLORS[i % COLORS.length] }))}
                total={total}
            />
        </div>
    );
